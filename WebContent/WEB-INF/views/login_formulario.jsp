...
<body>
	<div class="container col-md-12"
	    ...
	    <div class="row">
	     	<div class="col-md-4"></div>
	 	 	<span style="background-color: black;" class="label label-success col-md-4"><font size="6">REALIZAR LOGIN</font></span>
	 	 	<div class="col-md-4"></div>
	 	 </div>
	  	<br/><br/><br/><br/>
		<div class="row">
			<form class="form-signin col-md-12" action="login" method="post">
				<div class="form-group">
					<div class="row">
					    <div class="col-md-5"></div>
						<label for="papeis" class="col-md-4 control-label">Escolha um papel</label>
				...
				<div class=" row from-group col-md-6">
					...
					<label for="senha" class="control-label col-md-2">Senha: </label>
					<div class="col-md-5">
		  		...
		  		<div class="col-md-5"></div>
				<div class="row">
					<button class="btn btn-primary col-md-2" type="submit" >LOGAR</button>
				</div>
	...
	<div class="row col-md-6">
		Não é cadastrado? <a href="inserirUsuarioFormulario"> Cadastrar-se </a> <br/>
		Não queria logar? <a href="telaPrincipal"> Voltar a tela principal </a>
	</div>
	<div class="col-md-2"></div>
	<div class="row col-md-12"><font color="#fff">.</font></div> <!-- quebra de linha -->
	<div class="row col-md-12"><font color="#fff">.</font></div> <!-- quebra de linha -->
