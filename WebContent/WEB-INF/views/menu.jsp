		  	...
		  	<b>
		  		<font color="white">
		  			<c:if test="${papel=='jornalista'}">
		  				...
		  				Você está logado como <font color="red">JORNALISTA</font>, esse é um papel muito importante para 
		  				o sucesso do nosso site, você é reponsável por manter o site atualizado com 
		  				as mais recentes noticias do mundo Mario. Você pode criar uma noticia de
		  				qualquer seção e pode apagar e alterar as suas noticias.
		  			</c:if>
		  			<c:if test="${papel == 'editor'}">
		  				Seja bem vindo ao Jornal Super Mario.<br/>
		  				Você está logado como <font color="red">EDITOR</font>, isso significa que você tem grandes
		  				poderes, mas lembre-se, com grandes poderes, vem grandes responsabilidades. 
		  				Você possui um cargo administrativo, então você poderá:<br/>
		  				- Criar, Alterar e Excluir as Seções.<br/>
		  			...
		  			<c:if test="${papel == 'leitor'}">
		  				Seja bem vindo ao Jornal Super Mario.<br/>
		  				Você está logado como <font color="red">LEITOR</font>, muito obrigado por confiar no
		  				nosso site. Você poderá comentar as noticias postadas por nossos jornalistas, e realizar
