	...
	<div class="container col-md-12"
	    ...
	    <div class="row">
	     	<div class="col-md-4"></div>
	 	 	<span style="background-color: black;" class="label label-success col-md-4"><font size="6">CRIAR NOVA SEÇÃO</font></span>
	 	 	<div class="col-md-4"></div>
	 	 </div>
	  	<br/><br/><br/><br/>
		<div class="row">
			<form class="form-signin col-md-12" action="inserirSecao" method="post">
				...
				<div class=" row from-group col-md-6">
					...
					<div class="col-md-5">
						<input type="text" id="titulo" class="form-control" placeholder="Titulo da Seção" name="titulo" required autofocus>
					</div>
					...
					<div class="col-md-5">
						<input type="text" id="descricao" class="form-control" name="descricao" placeholder="Drescreva a Seção" required><br/>
					</div>
				</div>
		  </div>
